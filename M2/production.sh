...
outfile="output_M2_200_slepL.pkl"
...
for i in `seq 0 $len`; do
    ...
    sed -e "s/__M_L__/$mL/" -e "s/__M_R__/$mR/" -e "s/__M_1__/$M1/" -e "s/__M_2__/$M2/" -e "s/__A_t__/$At/" -e "s/__tb__/$tanb/" -e "s/__mu__/$mu/" -e "s/__MA__/$ma/" $template > $suspectfile
